...
@Table(name = "grupos")
@NamedQueries({
        @NamedQuery(name = "Grupo.masCanciones",query = "from Grupo g where size(g.canciones)>:numCanciones "),
        @NamedQuery(name = "Grupo.localidadPrimerDisco",query = "from Grupo g where g.localidad=:localidad and g.añograbacion=:anio")
})
public class Grupo {
    @Id
